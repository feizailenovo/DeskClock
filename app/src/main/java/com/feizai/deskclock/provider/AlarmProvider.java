package com.feizai.deskclock.provider;
...
/**
 * Author: chenhao
 * Date: 2022年3月26日 0026 下午 12:51:20
 * Describe: 闹钟数据库，对外提供增删查改
 */
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI(PACKAGE_NAME, "alarm", ALARMS);
        sURLMatcher.addURI(PACKAGE_NAME, "alarm/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
            LogUtil.v("Upgrading alarms database from version " +
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        LogUtil.v("*** notifyChange() rowId: " + rowId + " url " + url);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        LogUtil.v("Added alarm rowId = " + rowId);
